...
/**
 * Rcatalogueattachment Model
 *
 * @category FileManager.Model
 * @package  Croogo.Themesslider.Model
 * @version  1.0
 * @author   Fahad Ibnay Heylaal <contact@fahad19.com>
 * @license  http://www.opensource.org/licenses/mit-license.php The MIT License
 * @link     http://www.croogo.org
 */
class Rcatalogueattachment extends Node {

/**
 * alias
 */
	public $alias = 'Rcatalogueattachment';
 ...
 * type
 */
	public $type = 'rcatalogueattachment';
 ...
 */
	public function delete($id = null, $cascade = true) {
		$rcatalogueattachment = $this->find('first', array(
			'conditions' => array(
				$this->alias . '.id' => $id,
		...
		$filename = $rcatalogueattachment[$this->alias]['slug'];
