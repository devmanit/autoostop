<?php
App::uses('SpecificationsController', 'Rcatalogue.Controller');

/**
 * SpecificationsController Test Case
 *
 */
class SpecificationsControllerTest extends ControllerTestCase {
