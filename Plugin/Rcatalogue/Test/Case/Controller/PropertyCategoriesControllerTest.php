<?php
App::uses('PropertyCategoriesController', 'Rcatalogue.Controller');

/**
 * PropertyCategoriesController Test Case
 *
 */
class PropertyCategoriesControllerTest extends ControllerTestCase {
