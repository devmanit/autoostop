...
<div class="properties row-fluid">
        ...
        <div class="tab-content">
            ...
            <div id='property-address' class="tab-pane">
               ...
               $array_country = array_combine($array_country, $array_country);
                ...
                echo '<table class="table table-striped" style="width:100%;">';
                echo '<thead><tr><td><strong>Ville départ :</strong></td></tr></thead><tbody><tr><td>';
 ...
 <select id="secondselect" name="data[PropertyAddress][province]" class="span10" required="required">
                ...
                echo '<div class="span6">';
                echo '<table class="table table-striped" style="width:100%;">';
                echo '<thead><tr><td><strong>Ville d\'arrivé :</strong></td></tr></thead><tbody><tr><td>';
                     ...
                     <strong>Rendez-vous à :</strong>
                        <fieldset class="gllpLatlonPicker">
                            ...
                            <table class="table table-striped" style="width:100%;">
                                ...
                                <tr>
                                    <td>
                <?=  $this->Form->input('PropertyAddress.latitude', array(
                    'label' => false,'required' => true,'type' => 'number','step' => 'any',
                   'id' => 'PropertyAddressLatitude','style' => 'width:100%','class' => 'gllpLatitude'
                )); ?>
    
                                    </td>
                                    <td>
                 <?=  $this->Form->input('PropertyAddress.longitude', array(
                    'label' => false,'required' => true,'type' => 'number','step' => 'any',
                   'id' => 'PropertyAddressLongitude','style' => 'width:100%','class' => 'gllpLongitude'
                )); ?>
                                        
                                    </td>
                                    <td>
                 <?=  $this->Form->input('PropertyAddress.zoom', array(
                    'label' => false,'required' => true,'type' => 'number',
                   'id' => 'PropertyAddressZoom','style' => 'width:100%','class' => 'gllpZoom'
                )); ?>
                     ...
                     <strong>Point de chute à :</strong>
                        <fieldset class="gllpLatlonPicker">
                            ...
                            <table class="table table-striped" style="width:100%;">
                                ...
                                <tr>
                                    <td>
                   <?=  $this->Form->input('PropertyAddress.latitude_des', array(
                    'label' => false,'required' => true,'type' => 'number','step' => 'any',
                   'id' => 'PropertyAddressLatitudeDes','style' => 'width:100%','class' => 'gllpLatitude'
                )); ?> 
                                  
                                    </td>
                                    <td>
                    <?=  $this->Form->input('PropertyAddress.longitude_des', array(
                    'label' => false,'required' => true,'type' => 'number','step' => 'any',
                   'id' => 'PropertyAddressLongitudeDes','style' => 'width:100%','class' => 'gllpLongitude'
                )); ?> 
                                      
                                    </td>
                                    <td>
                       <?=  $this->Form->input('PropertyAddress.zoom_des', array(
                    'label' => false,'required' => true,'type' => 'number',
                   'id' => 'PropertyAddressZoomDes','style' => 'width:100%','class' => 'gllpZoom'
                )); ?> 
   ...
   $(document).ready(function() {
        ...
        $('a[href="#property-map"]').on('shown.bs.tab', function(e)
    {
        google.maps.event.trigger(mapdepart, 'resize');
         ...
         document.getElementById("searchdep").value = document.getElementById("PropertyAddressCity").value;
         document.getElementById("searchdes").value = document.getElementById("PropertyAddressCityDes").value;
