 ...
 */
class Slidesattachment extends Node {

/**
 * alias
 */
	public $alias = 'Slidesattachment';
 ...
 */
	public function delete($id = null, $cascade = true) {
		$slidesattachment = $this->find('first', array(
			'conditions' => array(
				$this->alias . '.id' => $id,
		...
		$filename = $slidesattachment[$this->alias]['slug'];
